...
var ISelect = /*#__PURE__*/function () {
  ...
  _createClass(ISelect, [{
    ...
    value: function init() {
      ...
      if (this.checkValid()) {
        _toConsumableArray(this.el.options).forEach(function (el) {
          return _this.options.push(el.value);
        });
      }
    }
  }, {
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","lib.js"], null)
//# sourceMappingURL=/lib.856d3ebb.js.map